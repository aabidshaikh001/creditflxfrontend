...
export default function Home() {
  ...
  return (
    <div>
      <section className="bg-white text-gray-950 py-10 px-4 md:px-16 flex flex-col md:flex-row items-center justify-between md:space-x-12">
        {/* Content Section */}
        <div className="max-w-lg md:w-1/2 text-center md:text-left">
          ...
          <p className="text-lg md:text-xl text-gray-900 mb-6">
            Welcome to Credits Fix: Where Smart Choices Meet Limitless Rewards
  ...
  {/* Apply Now Button */}
  <button
    className="inline-block bg-green-600 text-white px-6 py-3 rounded-lg text-lg hover:bg-green-800 transition duration-300"
    ...
    Apply Now
      ...
      <section className="bg-white text-gray-950 py-24 px-4 md:px-10 flex flex-col items-center text-center" id='about'>
        ...
        <h2 className="text-3xl md:text-4xl font-bold mb-4">
          Welcome To Credits Fix Consultancy Company
        </h2>
        <p className="text-lg text-gray-700 mb-4">
          We are a trusted consulting company.
        </p>
        <p className="text-lg text-gray-900 max-w-3xl mb-6">
          Welcome to Credits Fix Credit Cards: Smart solutions for modern spending. 
      ...
      <section className="bg-gray-50 text-gray-950 py-24 px-4 md:px-10" id='services'>
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-700">
            All CreditsFix Solutions: Silver Credit Card, Gold Credit Card, Diamond Credit Card, and Platinum Cards.
          </p>
        </div>
      ...
      <section className="bg-gradient-to-r from-gray-100 via-white to-gray-50 text-gray-950 py-24 px-6 md:px-20 flex flex-col md:flex-row items-center justify-between">
        ...
        {/* Image Section */}
        <div className="relative w-full md:w-1/2 h-64 md:h-auto flex justify-center items-center mt-10">
      ...
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-12">
        ...
        <div className="md:w-1/3 bg-white rounded-lg shadow-lg p-8 text-center md:text-left">
          ...
          <p className="text-gray-900 font-semibold">
            Email: <a href="mailto:creditsfixcompy@gmail.com" className="text-blue-600 hover:underline">creditsfixcompy@gmail.com</a>
          </p>
          <p className="text-gray-900 font-semibold mt-2">
            Phone: <a href="tel:+919257090322" className="text-blue-600 hover:underline">+91 9257090322</a>
          </p>
          <p className="text-gray-900 font-semibold mt-2">
            Address: Chomu thana mod, Laxmikant complex, shop no F16, jaipur, Rajsthan, 303702
          </p>
        </div>

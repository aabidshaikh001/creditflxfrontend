  ...
  <Link href="/" legacyBehavior>
    <a>
      <Image
        ...
        className='cursor-pointer bg-white rounded-lg shadow-md hover:shadow-xl transition duration-300 ease-in-out'
      />
    </a>
  </Link>
</div>
          <p className="text-gray-400 mb-4">
            Creditfix is your trusted partner in providing innovative credit card solutions. Discover seamless, secure, and rewarding experiences with us.
          </p>
          <p className="text-gray-400">
            © {new Date().getFullYear()} Creditfix. All rights reserved.
          </p>
        </div>
        ...
        <div>
          ...
          <p className="text-gray-400 mb-2 flex items-center">
            ...
            <a href="mailto:creditsfixcompy@gmail.com" className="hover:underline">
            creditsfixcompy@gmail.com
            </a>
          </p>
          <p className="text-gray-400 mb-2 flex items-center">
            <IconPhone className="h-5 w-5 mr-2 text-blue-500" />
            <a href="tel:+919257090322" className="hover:underline">
              +91 9257090322
            </a>
          </p>
          <p className="text-gray-400 flex items-center">
            <IconMapPin className="mr-2 text-blue-500" size={50} />
            Chomu thana mod, Laxmikant complex, shop no F16, jaipur, Rajsthan, 303702
          </p>
        </div>
      </div>

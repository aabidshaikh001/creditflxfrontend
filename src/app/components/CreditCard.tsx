  ...
  return (
    <div className="flex justify-center items-center cursor-pointer">
      <ReactCardFlip isFlipped={isFlipped} flipDirection="horizontal">
        {/* Front Side */}
        <div
          className="relative w-96 h-56 bg-gradient-to-br from-gray-800 to-black text-white rounded-lg shadow-lg p-4"
        ...
        {/* Back Side */}
        <div
          className="relative w-96 h-56 bg-gradient-to-br from-black to-gray-800 text-white rounded-2xl shadow-xl p-6"
        ...
        >
          ...
          <div className="absolute bottom-4 left-6">
            <p className="text-xs text-gray-400">
              For support, call (123) 456-7890 or visit www.creditfix.in
            </p>
          </div>
        </div>
      </ReactCardFlip>
